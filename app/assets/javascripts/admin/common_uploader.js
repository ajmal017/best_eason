// 需要进一步优化: 上传类型等
// 
// $("#upload_common_file_btn").uploader({url_field_id: "xxx"});
//
...
;(function ($) {
  ...
  $.fn.uploader = function(options){
    ...
    var dialogHtml = '\
      <div>\
        <form target="curform" class="real-file" enctype="multipart/form-data" action="/admin/uploaders" accept-charset="UTF-8" method="post">\
