Caishuo::Application.routes.draw do
  ...
  namespace :ajax do
    ...
    resource :global, controller: :global, only: [] do
      get :search, :screenshot, :market_infos, :market_time, :search_user, :search_stock, :stock_search
    end
  ...
  namespace 'admin' do
    ...
    resources :users, only: [:index] do
      member do
        post :set_company_user
        post :cancel_company_user
        post :reactivate
        get :quick_login
        post :blocked
      end
  ...
  namespace :mobile do
    ...
    get 'p2p/lending_protocol/:id' => "p2p#lending_protocol"
    get 'p2p/lending_notice/:id' => "p2p#lending_notice"
    get 'p2p/dc_protocol/:id' => "p2p#dc_protocol"
    get 'p2p/contract_protocol/:id' => "p2p#contract_protocol"
